...
void convolution3DCuda(DATA_TYPE* A, DATA_TYPE* B_outputFromGpu)
{
	...
	cudaMemPrefetchAsync(A, sizeof(DATA_TYPE) * NI * NJ *NK, 0,streams[0]);
	...
	cudaMemPrefetchAsync(B_outputFromGpu, sizeof(DATA_TYPE) * NI * NJ *NK, cudaCpuDeviceId,streams[0]);
...
int main(int argc, char *argv[])
{
	...
	cudaMallocManaged((void **)&B, sizeof(DATA_TYPE) * NI * NJ * NK);
